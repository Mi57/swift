...
/// Frontier mess with this by adding a utility method that populates a vector
/// of insertion points, where each each block-terminating lastUser adds an
/// insertion point at each successor block.
