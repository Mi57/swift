...
// that require indirect storage at the LLVM IR level. Consequently, this is a
// mandatory IRGen preparation pass.
//
...
// with multiple results, then the implementation complexity will fall away. See
// "TODO: MultiValue" below.
//
// TODO: Some of the current complexity stems from handling non-ownership
// SIL. If we decide to force SIL ownership up until this pass, then that
// complexity will fall away. See "TODO: Ownership" below.
//
...
//   parent object.
//
// - If this is a subobject projection, refer back to the value whose storage
//   object will be the parent that this storage address is a projection of.
//
...
//
// TODO: Ownership. This hack disappears with ownership SIL.
...
//
// These queries determine whether storage for SILValues can be project from its
// operands or uses. The answer must be consistent across both
