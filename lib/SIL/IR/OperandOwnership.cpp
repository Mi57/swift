...
// FIXME: OpenExistential[Box]Value should be a forwarding consume.
OPERAND_OWNERSHIP(InteriorPointer, OpenExistentialValue)
OPERAND_OWNERSHIP(InteriorPointer, OpenExistentialBoxValue)
...
// FIXME: These don't seem like they should be forwarding anything, if they
